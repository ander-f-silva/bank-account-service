...
class BalancesControllerTest {
    ...
    public static final String PATH_ACCOUNTS_RESOURCE = "/balances";
    ...
    void testShouldCreateAnNewAccount(String title, SearchBalance.UserCase userCase) throws Exception {
